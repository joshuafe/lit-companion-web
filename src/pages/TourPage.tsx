        ...
        <div className="grid lg:grid-cols-[1fr_1.1fr] gap-10 items-start">
          <div>
            ...
            <p className="font-serif text-[17px] leading-relaxed text-text-primary/85 mb-4">
              An excerpt from a real briefing — drafted, polished, and
              narrated in a voice tuned for biomedical vocabulary (no more
              "FOXP-three" or "C-D-four-plus" stumbles).
            </p>
            <p className="font-serif text-[14px] text-text-secondary leading-relaxed">
              ...
              <em> PNAS</em> study introducing a plasma cfDNA assay that
              tracks 96 patient-specific mutations to monitor AML after
              bone-marrow transplant, no needle required. ~85 seconds; turn
              the volume up.
            </p>
          </div>
            ...
            <div className="bg-bg-card rounded-2xl shadow-xl border border-stroke overflow-hidden">
              <div className="px-6 pt-6 pb-2">
                ...
                <div className="font-serif text-[17px] mt-1 font-semibold leading-snug">
                  A 96-mutation plasma cfDNA assay for tracking AML after
                  bone-marrow transplant
                </div>
                <div className="text-caption text-text-secondary mt-1">
                  PNAS · research · liquid biopsy
                </div>
              </div>
              ...
              <div className="bg-bg-primary/60 px-6 py-5 border-t border-stroke">
                ...
                <p className="font-serif text-[14px] leading-relaxed text-text-primary/85">
                  "The PNAS article introduces a plasma-based DNA test that
                  tracks up to ninety-six patient-specific somatic mutations
                  in acute myeloid leukemia after bone-marrow transplantation.
                  Ninety-six mutations is a hefty panel, and the ability to
                  monitor them non-invasively feels like swapping a needle
                  for a sip of water…"
                </p>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-bg-card rounded-2xl border border-stroke p-6 shadow-sm">
            ...
            <ul className="space-y-3 text-[14px] font-serif text-text-primary/85">
              ...
              <li>
                <strong>Not a social network.</strong> No likes — but you{" "}
                <em>can</em> easily share papers with colleagues, inside the
                app or out.
              </li>
              <li>
